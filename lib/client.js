		...
		const TYPERT_REMOTE = {
			...
			descriptors: [{
				...
				result: {
					...
					schema: zodRemoteResultSchema(),
				},
				sourceLocation: { file: "lib/index.js", line: 84, column: 3 },
			}],
		};

		/** Decode-only schema for the host result; mirrors lib/typert.host.js. */
		function zodRemoteResultSchema() {
			const z = require("zod");
			...
			return z.object({
				skills: z.array(z.object({
					...
					status: z.union([
						z.literal("behind"), z.literal("unknown"),
						z.literal("up_to_date"), z.literal("unmanaged"),
					]),
